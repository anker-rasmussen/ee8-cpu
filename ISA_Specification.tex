...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small\textcolor{ee8gray}{EE8 CPU --- ISA Specification v4.0}}
...
\begin{itemize}[nosep]
  \item \texttt{opcode} [15:12] --- Operation to perform
  \item \texttt{unused} [11:10] --- Reserved (should be set to 0)
  \item \texttt{Rd} [9:8] --- Destination register
...
\begin{tcolorbox}[colback=codebg, colframe=ee8blue, title={\large\bfseries EE8 CPU Quick Reference --- Version 4.0}, fonttitle=\color{white}]
\small
\begin{multicols}{2}
...
\textbf{Recommended:} Option B for clarity and full resource availability.
